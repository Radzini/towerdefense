...
const ENEMY_TYPES = {
    ...
    rubik_cube_cm1: { name: 'Rubik Cube', baseHp: 100000000, shieldHp: 25000000, speed: 0.215, color: '#FFFFFF', rainbow: true, size: 100, hasShield: true, isBoss: true, showHpBar: true, regeneration: { amount: 100, intervalMs: 100 }, backdashHpPercents: [0.8, 0.6, 0.4, 0.2], backdashTiles: 8, chaosAbilityRecoveryMs: 5000, chaosAbilities: [{ kind: 'cluster', count: 20, durationMs: 8000, cooldownMs: 30000 }, { kind: 'proxima', sizeTiles: 5, durationMs: 10000, cooldownMs: 12500 }, { kind: 'beam', widthTiles: 4, lengthTiles: 100, durationMs: 20000, cooldownMs: 60000 }, { kind: 'teleport', count: 8, durationMs: 12000, cooldownMs: 60000 }, { kind: 'bouncy', count: 5, bounces: 5, durationMs: 6000, cooldownMs: 25000 }] },
    super_crystalized_cube_cm1: { name: 'Super Crystalized Cube', baseHp: 20000000, shieldHp: 5000000, speed: 0.2, color: '#FF8C00', size: 65, hasShield: true, isBoss: true, showHpBar: true, chaosAbilityRecoveryMs: 5000, chaosAbilities: [{ kind: 'cluster', count: 8, durationMs: 6000, cooldownMs: 20000 }, { kind: 'proxima', sizeTiles: 3, durationMs: 8000, cooldownMs: 12000 }, { kind: 'bouncy', count: 3, bounces: 2, durationMs: 7000, cooldownMs: 40000 }] },
